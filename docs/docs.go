...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/books": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by bidang studi ID",
                    ...
                    {
                        "type": "string",
                        "description": "Filter by jenjang studi ID",
                    ...
                    {
                        "type": "string",
                        "description": "Filter by merk buku ID",
                        "name": "merk_buku_id",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Filter by periode",
                        "name": "periode",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Filter by kelas code (e.g., 1, 2, A, B, ALL)",
                        "name": "kelas",
                        "in": "query"
                    },
                    {
        ...
        "/api/curriculum": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "List of all curriculum with pagination",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/api/discount-rates": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "List of discount rates with pagination",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "DiscountRate details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "201": {
                        "description": "Created discount rate",
                        "schema": {
                            "$ref": "#/definitions/models.DiscountRate"
                        }
                    },
        ...
        "/api/discount-rates/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "DiscountRate ID (UUID)",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "DiscountRate not found",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated discount rate details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "Updated discount rate",
                        "schema": {
                            "$ref": "#/definitions/models.DiscountRate"
                        }
                    },
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "DiscountRate deleted successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/api/purchase-transactions": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Partial match on invoice number (No PO)",
                        "name": "no_invoice",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Partial match on supplier name or code",
                        "name": "supplier_name",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "integer",
                        "description": "Exact match: 0 (Pending), 1 (Selesai), 2 (Dibatalkan)",
                        "name": "status",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "List of all purchase transactions with pagination",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CreatePurchaseTransactionRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/models.PurchaseTransaction"
                        }
                    },
                    "400": {
                        "description": "Invalid request body",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.UpdatePurchaseTransactionRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/purchase-transactions/{id}/cancel": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/purchase-transactions/{id}/complete": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/purchase-transactions/{id}/receipt": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/reports/books-stock": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by kelas code",
                        "name": "kelas",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Sort by field (stock, name, created_at)",
                        "name": "sort_by",
                        "in": "query"
                    },
                    {
        ...
        "/api/reports/credits": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by sales associate ID",
                        "name": "sales_associate_id",
                        "in": "query"
                    },
                    {
                        "type": "boolean",
                        "description": "Show only overdue transactions",
                        "name": "overdue_only",
                        "in": "query"
                    }
                ],
        ...
        "/api/reports/purchases": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Filter by status (0=pending, 1=completed, 2=cancelled)",
                        "name": "status",
                        "in": "query"
                    }
                ],
        ...
        "/api/reports/sales": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by payment type (T=cash, K=credit, all=both)",
                        "name": "payment_type",
                        "in": "query"
                    },
                    {
    ...
    "definitions": {
        ...
        "handlers.CreatePurchaseTransactionRequest": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/handlers.CreatePurchaseTransactionItemReq"
                    }
                },
                "note": {
                    "type": "string"
        ...
        "handlers.CreateTransactionItemRequest": {
            ...
            "properties": {
                ...
                "discount": {
                    "description": "Percentage discount (0-100) applied after promotion",
                    "type": "number"
                },
                "promotion": {
                    "description": "Flat amount deduction from price",
                    "type": "number"
                },
                "quantity": {
                    "type": "integer"
        ...
        "handlers.UpdatePurchaseTransactionRequest": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
        ...
        "models.PurchaseTransaction": {
            ...
            "properties": {
                ...
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.PurchaseTransactionItem"
                    }
                },
                "no_invoice": {
                    "type": "string"
                ...
                "status": {
                    "description": "0 = pending, 1 = completed, 2 = cancelled",
                    "type": "integer"
                },
                "supplier": {
                    "$ref": "#/definitions/models.Publisher"
        ...
        "models.PurchaseTransactionItem": {
            "type": "object",
            "properties": {
                "book": {
                    "$ref": "#/definitions/models.Book"
